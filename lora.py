...
from loralib.utils import (
    ...
    apply_lora, get_lora_xs_parameters, 
...
def run_lora(args, clip_model, logit_scale, dataset, train_loader, val_loader, test_loader):
    ...
    # Number of params
    print_number_params(clip_model)
    
    optimizer = torch.optim.AdamW(get_lora_xs_parameters(clip_model), weight_decay=1e-2, betas=(0.9, 0.999), lr=args.lr)
    ...
    append_csv(args.result_filename, csv_dict)
